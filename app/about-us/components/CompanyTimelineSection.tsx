  ...
  const timelineEvents: TimelineEvent[] = [
    {
      ...
      title: 'Company Founded',
      description:
        'BTC Linx Enterprise was founded with the vision of creating intelligent, reliable, and scalable technology solutions for modern businesses.',
      icon: 'RocketLaunchIcon',
      category: 'founding'
    },
    {
      id: 2,
      year: '2025',
      title: 'Technology Framework Established',
      description:
        'Defined our engineering standards, architecture guidelines, and development workflows to ensure consistency and long-term scalability.',
      icon: 'Cog6ToothIcon',
      category: 'milestone'
    },
    {
      id: 3,
      year: '2025',
      title: 'Core Product Modules Built',
      description:
        'Developed initial versions of our AI-driven automation components, backend services, and internal platform tools.',
      icon: 'CpuChipIcon',
      category: 'innovation'
    },
    {
      id: 4,
      year: '2025',
      title: 'Infrastructure & Deployment Setup',
      description:
        'Established secure cloud infrastructure, continuous deployment pipelines, monitoring layers, and system reliability standards.',
    ...
    },
    {
      id: 5,
      year: '2025',
      title: 'Early Access Preparation',
      description:
        'Prepared our first solutions for early adopters and pilot testing, focusing on stability, usability, and efficient integration.',
      icon: 'UserGroupIcon',
      category: 'expansion'
    }
  ];
    ...
    <section className={`py-20 bg-white ${className}`}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            As a new technology company founded in 2025, our journey is focused on building solid
            engineering foundations, crafting meaningful products, and shaping the future of
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-primary/5 to-accent/5 rounded-2xl p-8 border border-primary/10">
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-bold text-foreground">Looking Ahead</h3>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our future vision focuses on refining our products, collaborating with early
                adopters, onboarding our first clients, and expanding our technological
                capabilities responsibly and strategically.
              </p>

              <div className="flex justify-center gap-4 mt-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">2025</div>
                  <div className="text-sm text-muted-foreground">First Client Onboarding</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">2026</div>
                  <div className="text-sm text-muted-foreground">Product Ecosystem Growth</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary">2027</div>
                  <div className="text-sm text-muted-foreground">Enterprise Presence</div>
                </div>
              </div>
            </div>
          </div>
